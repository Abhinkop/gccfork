...
/**
 ** \file MylangParser.h
 ** Define the mylang::parser class.
 */
...
switch (yykind)
    {
      ...
      {
        return MylangParser::symbol_name (this->kind ());
      }
#endif // #if YYDEBUG || 0
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    MylangParser (const MylangParser&) = delete;
    /// Non copyable.
    MylangParser& operator= (const MylangParser&) = delete;
#endif
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_FLOATLITERAL (std::string v)
      {
        return symbol_type (token::FLOATLITERAL, std::move (v));
      }
#else
      static
      symbol_type
      make_FLOATLITERAL (const std::string& v)
      {
        return symbol_type (token::FLOATLITERAL, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    MylangParser (const MylangParser&);
    /// Non copyable.
    MylangParser& operator= (const MylangParser&);
#endif
